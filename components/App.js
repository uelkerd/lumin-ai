// App.js
// Main application component for the LUMIN.AI Project Hub
...
const App = () => {
    ...
    // Function to render the appropriate page based on the active page state
    // This manages the application's main content area based on the activePage state
    // Each page component receives necessary props for proper rendering and state management
    const renderPage = () => {
        switch(activePage) {
            case 'docsHub':
                return <DocsHub docFileMapping={docFileMapping} />;
            case 'roadmapCanvas':
                return (
