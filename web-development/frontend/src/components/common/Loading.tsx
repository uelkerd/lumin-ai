...
const Loading: React.FC<LoadingProps> = ({
  ...
  const renderSpinner = () => (
    <div
      className={`${getSizeClasses()} border-4 border-gray-200 border-t-blue-500 rounded-full animate-spin`}
    />
  );
...
export const SkeletonLoading: React.FC = () => <Loading variant="skeleton" />;
