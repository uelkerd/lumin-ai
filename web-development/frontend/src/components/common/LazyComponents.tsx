...
export const LazyWrapper: React.FC<LazyWrapperProps> = ({ 
  children, 
  fallback,
  errorFallback = <div className="error-container">Failed to load component</div>,
...
export const createLazyFeature = (importFn: () => Promise<{ default: ComponentType<any> }>) => {
  return React.lazy(() => 
      ...
      return {
        default: () => (
          <div className="error-container">
            ...
            <p>This feature could not be loaded. Please try refreshing the page.</p>
          </div>
        )
      };
    })
