          ...
          trustMetrics: [
            {
              ...
              value: 7.2,
              change: 0.3,
              description: 'Composite trust indicator across all governance dimensions',
              icon: '🏛️'
            },
            {
              id: 'transparency',
              ...
              value: 8.1,
              change: 0.5,
              description: 'Measure of government openness and information accessibility',
              icon: '🔍'
            },
            {
              id: 'participation',
              ...
              value: 6.8,
              change: -0.2,
              description: 'Level of citizen engagement in democratic processes',
              icon: '🗳️'
            },
            {
              id: 'accountability',
              ...
              value: 7.5,
              change: 0.1,
              description: 'Effectiveness of oversight and responsibility mechanisms',
              icon: '⚖️'
            }
          ],
    ...
    return (
      <div className="metric-card fade-in">
        ...
        <div className="flex items-center gap-sm mb-md">
          ...
          <span className="text-xs" style={{ color: 'var(--color-silver-grey)' }}>
            vs. last month
          </span>
        </div>
  ...
  return (
    <div className="App">
      ...
      <div className="app-main">
        ...
        {/* Footer */}
        <div className="text-center mt-2xl p-lg" style={{ color: 'var(--color-silver-grey)' }}>
          <p className="text-sm">
            Last updated: {dashboardData.lastUpdated} | 
            Data sources: Democracy Radar, Transparency International, Civic Engagement Index
          </p>
        </div>
      </div>
    </div>
