    ...
    const loadDashboardData = async () => {
      try {
        ...
        const mockData: DashboardData = {
          ...
          recentUpdates: [
            { id: 1, title: 'Trust score increased by 2.3%', date: '2023-06-15' },
            { id: 2, title: 'New governance data integrated', date: '2023-06-10' },
            { id: 3, title: 'Sentiment analysis model updated', date: '2023-06-05' },
          ]
        };
  ...
  return (
    <div className="dashboard-container fade-in">
      ...
      <p className="dashboard-subtitle">
        Real-time insights into democratic governance metrics and sentiment analysis
      </p>
