  ...
  return (
    <div className="demographic-analysis-container fade-in">
      ...
      <p className="section-description">
        Explore how democratic trust patterns vary across different demographic
        groups
      </p>
      ...
      <div className="statistical-significance">
        ...
        <p>
          All demographic comparisons include appropriate statistical
          significance testing with multiple comparison corrections. Effect size
          calculations provide practical significance assessment beyond
      ...
      <div className="methodology-section">
        <h3>Methodology</h3>
        <p>
          Demographic analysis uses ANOVA and post-hoc testing for group
          comparisons across age, education, income, geographic regions, and
          political party affiliation. All analyses include appropriate effect
          size calculations and confidence intervals.
        </p>
      </div>
    </div>
  );
