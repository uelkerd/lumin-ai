  ...
  return (
    <div className="sentiment-analysis-container fade-in">
      ...
      {result && !analyzing && (
        <div className="sentiment-result glass-card">
          ...
          <div className="sentiment-details">
            <div className="key-phrases">
              ...
              <div className="phrase-tags">
                {result.explanation.key_phrases.map((phrase: string, index: number) => (
            ...
            <div className="feature-importance">
              ...
              <div className="importance-bars">
                {Object.entries(result.explanation.feature_importance).map(([feature, importance]: [string, any]) => (
                  <div key={feature} className="importance-item">
                    ...
                    <span className="importance-value">{(importance * 100).toFixed(0)}%</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="interpretation-guidance">
            ...
            <p>
              This sentiment analysis is specifically trained on governance and democratic discourse.
              The model identifies emotional tone and attitude toward governance concepts, with confidence
              scores indicating prediction reliability. Higher confidence (above 80%) suggests stronger
              sentiment signals in the text.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="methodology-section">
        ...
        <p>
          Our sentiment analysis model is specifically trained on governance texts and democratic
          discourse, achieving 85%+ accuracy on governance-specific language. The model uses
          transformer architecture to understand context and nuance in policy discussions,
          public feedback, and civic engagement materials.
        </p>
      </div>
    </div>
  );
