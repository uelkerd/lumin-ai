...
const mockCorrelations = {
  ...
  "description": "Correlation matrix showing relationships between key variables."
};

const mockSentimentResponse = {
  "sentiment": "positive",
  "confidence": 0.85,
  "interpretation_guidance": "The model is highly confident that the sentiment is positive."
};
...
const mockSentimentTrends = [
  {
  ...
  },
   {
    ...
    "sentiment_distribution": {"positive": 0.45, "neutral": 0.30, "negative": 0.25}
  }
];
...
const batchAnalyzeSentimentMock = () => simulateApiCall(mockBatchSentimentResponse);
