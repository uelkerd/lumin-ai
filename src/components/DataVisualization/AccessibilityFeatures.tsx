...
interface AccessibilityControlsProps {
  onColorSchemeChange: (
    scheme: "default" | "colorblind" | "grayscale" | "high-contrast",
  ) => void;
...
const AccessibilityControls: React.FC<AccessibilityControlsProps> = ({
  ...
  const [colorScheme, setColorScheme] = useState<
    "default" | "colorblind" | "grayscale" | "high-contrast"
  >("default");
        ...
        <div className="absolute top-full right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 p-4 z-50">
          ...
          <div className="mb-4">
            ...
            <select
              value={colorScheme}
              onChange={(e) =>
                handleColorSchemeChange(e.target.value as typeof colorScheme)
              }
...
export const ScreenReaderAnnouncements: React.FC<{ message: string }> = ({
  message,
}) => {
  return (
    <div
